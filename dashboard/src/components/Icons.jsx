...
const IconBase = ({ children, size = 18, color = 'currentColor', className = '', ...props }) => (
  <svg
...
export const IconGemini = ({ size = 18, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={`ai-icon ${className}`} style={{ display: 'inline-block', verticalAlign: 'middle' }}>
